...
function init(blip, siteDock){
    ...
    let pageTitle = 'IOport Blip - Web Application Framework';
    let pageDescription = 'The IOport Blip web application framework home page.';
    let pageKeywords = 'blip, io blip, ioport blip, ioportblip, ioport blip web application framework, io blip web application framework';

    var templatePage = new blip.templateAssembler.TemplateEngine(siteDock, siteDock.url.pageHome, true);
    ...
    var htmlIncludes = {
        ...
        css: [{sipTag: siteDock.templateCommonFrag.fileHeader.htmlIncludes.css[
               ...
               externalFile: '<link rel="stylesheet" href="' + siteDock.path.clientThemePagesCssDir + 'Home' +
                             blip.svar.cssExt + '" />\n'}],
         ...
         js: [{sipTag: siteDock.templateCommonFrag.fileHeader.htmlIncludes.js[
               ...
               externalFile: '<script src="' + siteDock.path.clientThemePagesJsDir + 'Home' +
    ...
    var templateFragPageBodyId = templatePage.addFragFilePath(
        siteDock.path.templatesPagesDir + 'Page_Home-Body.html.tpl', false );
